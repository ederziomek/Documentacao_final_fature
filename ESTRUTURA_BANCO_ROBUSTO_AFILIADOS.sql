...
CREATE TABLE affiliates (
    ...
    INDEX idx_affiliate_registration (registration_date),
    INDEX idx_affiliate_activity (last_activity),
    INDEX idx_affiliate_performance (total_validated_referrals, total_cpa_earned)
);
...
CREATE TABLE affiliate_mlm_structure (
    ...
    INDEX idx_mlm_affiliate (affiliate_id),
    INDEX idx_mlm_network_size (total_network_size),
    INDEX idx_mlm_calculation (last_calculated)
);
...
CREATE TABLE affiliate_referrals (
    ...
    INDEX idx_referrals_level (mlm_level),
    INDEX idx_referrals_status (status),
    INDEX idx_referrals_validation (validation_date),
...
CREATE TABLE affiliate_cpa_validations (
    ...
    FOREIGN KEY (affiliate_id) REFERENCES affiliates(affiliate_id),
    INDEX idx_cpa_affiliate (affiliate_id),
    INDEX idx_cpa_validation_date (validation_date),
    INDEX idx_cpa_status (cpa_status),
    INDEX idx_cpa_level (cpa_level)
);
...
CREATE TABLE affiliate_periodic_summaries (
    ...
    FOREIGN KEY (affiliate_id) REFERENCES affiliates(affiliate_id),
    INDEX idx_summary_affiliate (affiliate_id),
    INDEX idx_summary_period (period_type, period_start),
    UNIQUE KEY uk_summary_period (affiliate_id, period_type, period_start)
);
...
CREATE TABLE affiliate_cache_metadata (
    ...
    FOREIGN KEY (affiliate_id) REFERENCES affiliates(affiliate_id),
    INDEX idx_cache_affiliate (affiliate_id),
    INDEX idx_cache_type (cache_type),
    INDEX idx_cache_update (next_update)
);
